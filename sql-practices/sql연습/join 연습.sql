...
-- 예제1: 현재 근무하고 있는 직원의 이름과 직책을 출력 하세요.
...
--
-- 1) natural join
-- 두 테이블에 이름이 같은 공통 컬럼이 있으면 별다른 join 조건을 명시하지 않아도 암묵적으로 조인이 됨.
select a.emp_no, a.first_name, b.title
...
-- 실습문제1 : 현재 회사 상황을 반형한 직원별 근무부서를 사번, 직원 전체이름, 근무부서 형태로 출력해 보세요.
...
select b.dept_no as '부서', c.title as '직책', a.first_name as '이름', avg(d.salary) as '평균급여' 
